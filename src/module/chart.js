...
const draw = (id) => {
  ...
  const tooltip = d3.select('body')
    ...
    // "'Lucida Grande', 'Avenir', Helvetica, Arial, sans-serif;"
  ...
  // const xAxisVerticalLine =
  xAxis.selectAll('line').attr('stroke', '#DDDDDD')
  ...
  yAxis.append('text')
    ...
    .attr('font-weight', 'bold')
    .attr('font-size', 16)
    .style('font-family', "'Lucida Grande', 'Avenir', Helvetica, Arial, sans-serif;")
